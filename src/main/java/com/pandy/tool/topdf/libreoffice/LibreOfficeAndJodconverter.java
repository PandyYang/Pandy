...
public class LibreOfficeAndJodconverter {
    ...
    public static void destroy() throws OfficeException {
    ...
    public static void task() throws OfficeException {
        ...
        doDocToFdpLibre("123.docx", outputname);
        doDocToFdpLibre("123.pptx", outputname);
        doDocToFdpLibre("123.xlsx", outputname);
    }

    public static String doDocToFdpLibre(String inputFileName, String outputFileName) throws OfficeException {
        File inputFile = new File("D:\\IdeaProjects\\com.pandy.base\\src\\main\\resources\\test\\all\\" + inputFileName);
