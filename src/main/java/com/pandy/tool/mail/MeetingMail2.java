...
public class MeetingMail2 {
    ...
    public static void sendMeetingInvitationEmail() {
        try {
            ...
            props.put("com.pandy.tool.mail.smtp.port", "465");
            props.put("com.pandy.tool.mail.smtp.host", "smtp.qq.com");
            //当前smtp host设为可信任 否则抛出javax.com.pandy.tool.mail.MessagingException: Could not                   convert socket to TLS
            props.put("com.pandy.tool.mail.smtp.ssl.trust", "smtp.qq.com");
            props.put("com.pandy.tool.mail.transport.protocol", "smtp");
            props.put("com.pandy.tool.mail.smtp.auth", "true");
            props.put("com.pandy.tool.mail.smtp.starttls.enable", "true");
            props.put("com.pandy.tool.mail.smtp.ssl", "true");
            //开启debug调试，控制台会打印相关信息
            //props.put("com.pandy.tool.mail.debug", "true");
            MailSSLSocketFactory sf = new MailSSLSocketFactory();
            sf.setTrustAllHosts(true);
            props.put("com.pandy.tool.mail.smtp.ssl.enable", "true");
            props.put("com.pandy.tool.mail.smtp.ssl.socketFactory", sf);
